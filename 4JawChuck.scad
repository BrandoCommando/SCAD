...
part = "jaws"; // [jaws:Jaws,gears:Drive Gears,ring:Gear Ring,face:Face Housing,rear:Rear Housing,scroll:Scroll,all:All parts]
N = 4;						//number of jaws (1, 2, 3, 4, 5, or 6) *works best at 3 and 4, 7 overlaps
...
if(part=="jaws"||part=="all")
  jaws();
if(part=="gears"||part=="all")
  gears();
if(part=="ring"||part=="all")
  gear_ring();
if(part=="face"||part=="all")
  face_housing();
if(part=="rear"||part=="all")
  rear_housing();
if(part=="scroll"||part=="all")
  scroll();
